...
<nav id="nav" role="navigation">
    <div class="container_nav">
        <div class="container-selector">
            <a href="javascript:cargar('#portada','/views/vertrabajadores.php?id=<?php echo $id; ?>');">Trabajadores</a>
        </div>        
        <div class="container-selector">
        ...
        <div class="container-selector">
            <a href="javascript:cargar('#portada','/views/vercontratistas.php');">Contratistas</a>
        </div>
    </div>
    <div class="usuario">
